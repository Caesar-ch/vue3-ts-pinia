<template>
  <div class="cart">
    <RouterLink class="curr" to="/cart">
      <i class="iconfont icon-cart"> 🛒</i><em>{{store.validTotal}}</em>
    </RouterLink>

    <div class="layer" v-if="store.validTotal && $route.path!=='/cart'">
      <div class="list">
        <div class="item" v-for="item in store.validList" :key=" item.skuId">
