<template>
  <div class="order-item">
    <div class="head">
      ...
      <!-- 已完成 已取消 -->
      <a @click="$emit('on-delete', order)" v-if="[5, 6].includes(order.orederState)" href="javascript:;"
        class="del">删除</a>
    </div>
    <div class="body">
      ...
      <div class="column state">
        ...
        <!-- 待评价：评价商品 -->
        <!-- 已完成：查看评价 -->
        <p @click="$emit('on-logistics', order)" v-if="order.orderState === 3"><a href="javascript:;"
      ...
      <div class="column action">
        ...
        <p @click="$emit('on-canel', order)" v-if="order.orderState === 1"><a href="javascript:;">取消订单</a>
        </p>
...
const emits = defineEmits(['on-canel', 'on-delete', 'on-confirm', 'on-logistics'])
